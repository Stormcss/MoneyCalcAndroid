...
public class HistoryFab extends FloatingActionButton implements AnimatedFab {

    private static final int FAB_ANIM_DURATION = 200;

    public HistoryFab(Context context) {
        super(context);
    }

    public HistoryFab(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HistoryFab(Context context, AttributeSet attrs, int defStyleAttr) {
